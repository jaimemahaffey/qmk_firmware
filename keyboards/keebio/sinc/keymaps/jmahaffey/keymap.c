...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_80_with_macro_wrapper(
    KC_MPRV,           KC_ESC ,          _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR,
    ...
    RGB_VAI, RGB_VAD,  _______, KC_HASH, KC_DLR,  KC_LPRN    , KC_RPRN    , KC_GRAVE,    _______, KC_LEFT, KC_DOWN, KC_RGHT,  _______, _______,          _______, KC_VOLU,
