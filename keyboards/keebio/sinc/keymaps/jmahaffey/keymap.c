...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_QWERTY] = LAYOUT_80_with_macro_wrapper(
    ...
    KC_F9,   KC_F10,  KC_LCTL, KC_LALT, KC_LGUI, KC_LOWR,  _______,  KC_SPC,        _______, KC_SPC, KC_RALT, KC_RCTL, KC_RASE, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT_80_with_macro_wrapper(
    ...
    RGB_HUI, RGB_HUD,  KC_DEL ,          _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,  _______, _______, KC_MPRV,
